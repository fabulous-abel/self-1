...
class _DriverLoginScreenState extends State<DriverLoginScreen> {
  ...
  String? _validatePhone(String? value) {
    ...
    if (rawValue.isEmpty) return 'Enter a valid phone number';
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isLogin) {
        ...
        final vehicleInfo = _vehicleController.text.trim().isEmpty
            ? 'Vehicle Pending'
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _isLogin ? 'Back on the road.' : 'Join the driver fleet.',
          ...
          // Removed highlight cards per request
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              _isLogin ? 'Driver Login' : 'Driver Sign Up',
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                helperText: 'Must be an active Ethiopian number',
              ),
            ),
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(
                  _isLogin ? 'Login to Dashboard' : 'Create Driver Account',
                ),
              ),
            ),
            ...
            Center(
              child: TextButton(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: DriverColors.teal),
                ),
              ),
            ),
          ],
